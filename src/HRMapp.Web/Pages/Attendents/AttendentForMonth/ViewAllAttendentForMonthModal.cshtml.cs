...
public class ViewAllAttendentForMonthModalModel : ExportAllAttendentForMonthModalModel
{

    private readonly IAttendentForMonthAppService _service;

    public ViewAllAttendentForMonthModalModel(IAttendentForMonthAppService service) : base(service)
    {
        _service = service;
    }
}